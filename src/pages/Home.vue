  ...
  <div class="relative bg-white overflow-hidden">
          ...
          <div class="relative pt-6 px-4 sm:px-6 lg:px-8">
            <nav class="relative flex items-center justify-between sm:h-10 lg:justify-start" aria-label="Global">
              ...
              <div class="hidden md:block md:ml-10 md:pr-4 md:space-x-8">
                <a href="https://github.com/morellexf13/tuto" target="_blank"
          ...
          <div class="sm:text-center lg:text-left">
            ...
            <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
              ...
              <div class="mt-3 sm:mt-0 sm:ml-3">
                <a href="#" id="btn-track-spotify" v-on:click="shouldShowSpotifyTracker = true"
    ...
    <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
      <img class="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full"
        src="https://images.unsplash.com/photo-1611264327630-8090373c8cef?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8aGVsbG8lMjB3b3JsZHxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=900&q=60"
        alt="">
    </div>
  </div>
</template>
